...
$fn = 100;
difference(){
translate([0,0,2]) cylinder(r=22,h=10,center=true);
}
}
...
{
	translate ([0,0,12])
	test_double_helix_gear (teeth=5,circles=0);
	translate ([0,0,0])	rodinha();
	mirror ([0,1,0])
	translate ([80,0,0])
	test_double_helix_gear (teeth=8,circles=0);
}
		...
		translate ([0,0,0])
		{
			translate ([0,0,6])
			{
				...
				gear (number_of_teeth=6,
					...
					pressure_angle=31);
				translate([0,0,0])
				cylinder(r=1.2, h=40, center = true, $fn = 100);
				}
				rotate ([0,0,360*5/6])
				translate ([0,0,0])
				gear (number_of_teeth=21,
...
difference(){
translate([3.32,35.85,3.5])
cylinder(r=3.4, h=13, center = true, $fn = 100);
translate([3.32,35.85,3])
cylinder(r=1.2, h=40, center = true, $fn = 100);
}